 ...
 */
class IsPaymentAppPaymentStatusRefundFailedConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritDoc}
     *
    ...
    public function check(SpySalesOrderItem $orderItem): bool
    {
        $paymentAppPaymentStatusRequestTransfer = (new PaymentAppPaymentStatusRequestTransfer())
            ...
            ->setStatus(PaymentStatus::STATUS_REFUND_FAILED);
