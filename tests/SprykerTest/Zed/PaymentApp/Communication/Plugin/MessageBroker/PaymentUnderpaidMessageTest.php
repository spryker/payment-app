 ...
 * @group Plugin
 * @group MessageBroker
 * @group PaymentUnderpaidMessageTest
 * Add your own group annotations below this line
 */
class PaymentUnderpaidMessageTest extends Unit
{
    ...
    public function testGivenNoStatusEntityForAPaymentExistsWhenThePaymentUnderpaidMessageIsHandledThenAStatusEntityIsCreated(): void
    {
        ...
        // Act
        $this->tester->receivePaymentUnderpaidMessage([PaymentUnderpaidTransfer::ORDER_REFERENCE => $orderReference]);
    ...
    public function testGivenNoStatusEntityForAPaymentExistsWhenThePaymentUnderpaidMessageIsHandledThenAStatusHistoryEntityIsCreated(): void
    {
        ...
        // Assert
        $this->tester->assertPaymentAppPaymentStatusHistoryEntityExists($orderReference, PaymentStatus::STATUS_UNDERPAID);
    }
}
