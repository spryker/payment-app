 ...
 * @group Plugin
 * @group Oms
 * @group IsPaymentAppPaymentAppPaymentStatusCapturedStatusConditionPluginTest
 * Add your own group annotations below this line
 */
class IsPaymentAppPaymentAppPaymentStatusCapturedStatusConditionPluginTest extends AbstractIsPaymentAppPaymentStatusConditionPluginTest
{
    ...
    public static function statusProvider(): array
    {
        return [
            ...
            PaymentStatus::STATUS_CAPTURED . ' payments will MATCH' => [PaymentStatus::STATUS_CAPTURED, true], // Capture had previous state of "authorized"
