 ...
 * @group Plugin
 * @group Oms
 * @group IsPaymentAppPaymentAppPaymentStatusCanceledStatusConditionPluginTest
 * Add your own group annotations below this line
 */
class IsPaymentAppPaymentAppPaymentStatusCanceledStatusConditionPluginTest extends AbstractIsPaymentAppPaymentStatusConditionPluginTest
{
    ...
    public static function statusProvider(): array
    {
        return [
            ...
            PaymentStatus::STATUS_CANCELED . ' payments will MATCH' => [PaymentStatus::STATUS_CANCELED, true],
    ...
    {
        return new IsPaymentAppPaymentStatusCanceledConditionPlugin();
    }
}
