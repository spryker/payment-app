 ...
 * @group Plugin
 * @group Oms
 * @group IsPaymentAppPaymentAppPaymentStatusCaptureFailedStatusConditionPluginTest
 * Add your own group annotations below this line
 */
class IsPaymentAppPaymentAppPaymentStatusCaptureFailedStatusConditionPluginTest extends AbstractIsPaymentAppPaymentStatusConditionPluginTest
{
    ...
    public static function statusProvider(): array
    {
        return [
            ...
            PaymentStatus::STATUS_CAPTURE_FAILED . ' payments will MATCH' => [PaymentStatus::STATUS_CAPTURE_FAILED, true], // End state
    ...
    {
        return new IsPaymentAppPaymentStatusCaptureFailedConditionPlugin();
    }
}
