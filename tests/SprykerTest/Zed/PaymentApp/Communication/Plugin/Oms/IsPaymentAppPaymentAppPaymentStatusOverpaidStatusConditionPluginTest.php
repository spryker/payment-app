 ...
 * @group Plugin
 * @group Oms
 * @group IsPaymentAppPaymentAppPaymentStatusOverpaidStatusConditionPluginTest
 * Add your own group annotations below this line
 */
class IsPaymentAppPaymentAppPaymentStatusOverpaidStatusConditionPluginTest extends AbstractIsPaymentAppPaymentStatusConditionPluginTest
{
    ...
    {
        return new IsPaymentAppPaymentStatusOverpaidConditionPlugin();
    }
}
