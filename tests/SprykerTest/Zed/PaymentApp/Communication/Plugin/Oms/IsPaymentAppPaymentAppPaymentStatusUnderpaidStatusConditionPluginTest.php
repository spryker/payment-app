 ...
 * @group Plugin
 * @group Oms
 * @group IsPaymentAppPaymentAppPaymentStatusUnderpaidStatusConditionPluginTest
 * Add your own group annotations below this line
 */
class IsPaymentAppPaymentAppPaymentStatusUnderpaidStatusConditionPluginTest extends AbstractIsPaymentAppPaymentStatusConditionPluginTest
{
