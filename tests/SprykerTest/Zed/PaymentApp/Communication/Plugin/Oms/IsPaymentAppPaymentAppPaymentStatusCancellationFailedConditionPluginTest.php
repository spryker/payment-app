 ...
 * @group Plugin
 * @group Oms
 * @group IsPaymentAppPaymentAppPaymentStatusCancellationFailedConditionPluginTest
 * Add your own group annotations below this line
 */
class IsPaymentAppPaymentAppPaymentStatusCancellationFailedConditionPluginTest extends AbstractIsPaymentAppPaymentStatusConditionPluginTest
{
    ...
    public static function statusProvider(): array
    {
        return [
            ...
            PaymentStatus::STATUS_CANCELLATION_FAILED . ' payments will MATCH' => [PaymentStatus::STATUS_CANCELLATION_FAILED, true], // End state
