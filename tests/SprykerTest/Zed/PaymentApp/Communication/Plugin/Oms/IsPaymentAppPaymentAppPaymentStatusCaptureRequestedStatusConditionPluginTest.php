 ...
 * @group Plugin
 * @group Oms
 * @group IsPaymentAppPaymentAppPaymentStatusCaptureRequestedStatusConditionPluginTest
 * Add your own group annotations below this line
 */
class IsPaymentAppPaymentAppPaymentStatusCaptureRequestedStatusConditionPluginTest extends AbstractIsPaymentAppPaymentStatusConditionPluginTest
{
    ...
    public static function statusProvider(): array
    {
        return [
            ...
            PaymentStatus::STATUS_CAPTURE_FAILED . ' payments will NOT MATCH' => [PaymentStatus::STATUS_CAPTURE_FAILED, false], // End state
            PaymentStatus::STATUS_CAPTURE_REQUESTED . ' payments will MATCH' => [PaymentStatus::STATUS_CAPTURE_REQUESTED, true],
    ...
    {
        return new IsPaymentAppPaymentStatusCaptureRequestedConditionPlugin();
    }
}
